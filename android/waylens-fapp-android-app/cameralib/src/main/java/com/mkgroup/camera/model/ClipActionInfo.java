...
public class ClipActionInfo {
    ...
    public static final int CLIP_ACTION_CREATED = 1; // request single clip
    public static final int CLIP_ACTION_CHANGED = 2; // update current clip duration
    public static final int CLIP_ACTION_FINISHED = 3; // request single clip
    public static final int CLIP_ACTION_INSERTED = 4;
    public static final int CLIP_ACTION_MOVED = 5;

    public final Clip clip; // incomplete
