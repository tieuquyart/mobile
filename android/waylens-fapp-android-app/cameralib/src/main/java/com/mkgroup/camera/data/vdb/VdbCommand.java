...
/**
 * Created by doanvt on 2015/8/19.
 */
public class VdbCommand {
    ...
    private static class Builder {
        ...
        private Builder writeLEDouble(double value) {
            mVdbCommand.writei64(Double.doubleToLongBits(value));
            return this;
        }

        private Builder writeLEFloat(float value) {
            mVdbCommand.writei32(Float.floatToIntBits(value));
            return this;
        }
    ...
    public static class Factory {
        ...
        // since version 1.6
        //-----------------------
        public static final int MSG_PlaylistCreated = MSG_START + 9;
        public static final int MSG_PlaylistDeleted = MSG_START + 10;

        public static final int MSG_MarkLiveClipInfo = MSG_START + 32;

        public static final int MSG_SpaceInfo = MSG_START + 40;

        public static final int MSG_RefreshPictureList = MSG_START + 64;
        public static final int MSG_PictureTaken = MSG_START + 65;
        public static final int MSG_PictureRemoved = MSG_START + 66;

        //-----------------------
        // since version 1.6
        //-----------------------
        public static final int MSG_CLIP_ATTR = MSG_START + 80;
        ...
        public static VdbCommand createCmdGetRawData(Clip.ID cid, long clipTimeMs, int type) {
            return new Builder()
        ...
        public static VdbCommand createCmdSetSceneData(Clip.ID cid, Clip.LapTimerData lapTimerData, int dataSize) {
            int fcc = ('L' << 24) + ('A' << 16) + ('P' << 8) + 'T';
            return new Builder()
                    .writeCmdCode(VDB_CMD_SetSceneData, 0)
                    .writeClipId(cid)
                    .writeInt64(0)
                    .writeInt32(dataSize + 4)
                    .writeInt32(fcc)
                    .writeInt32(dataSize)
                    .writeLEDouble(lapTimerData.latitude)
                    .writeLEDouble(lapTimerData.longitude)
                    .writeInt32((int) lapTimerData.utcTime)
                    .writeInt32((int) lapTimerData.utcTimeUsec)
                    .writeLEFloat(lapTimerData.euler_heading)
                    .writeInt32(lapTimerData.trackId)
                    .build();
        }
