 ...
 */
public interface DashboardFragmentViewModel {
    ...
    final class ViewModel extends FragmentViewModel<DashBoardFragment> implements Inputs, Outputs, Errors {

        private static final String TAG = DashboardFragmentViewModel.ViewModel.class.getSimpleName();
