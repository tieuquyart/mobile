...
public class CustomCsvFormatStrategy implements FormatStrategy {
    ...
    public static CustomCsvFormatStrategy.Builder newBuilder() {
        return new CustomCsvFormatStrategy.Builder();
    }
    ...
    public static final class Builder {
        ...
        public CustomCsvFormatStrategy build() {
            ...
            if (logStrategy == null) {
                ...
                //String folder = diskPath + File.separatorChar + "logger" + File.separatorChar;
                String folder = FileUtils.getLogPath(HornApplication.getContext());
