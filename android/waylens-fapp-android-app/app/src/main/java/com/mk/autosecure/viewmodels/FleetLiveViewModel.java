...
public interface FleetLiveViewModel {
    interface Inputs {
        ...
        void queryLiveSignal(String sn, double rsps);
    ...
    final class ViewModel extends ActivityViewModel<LiveViewActivity> implements Inputs, Outputs, Errors, WOWZStatusCallback {
        public static final String TAG = FleetLiveViewModel.ViewModel.class.getSimpleName();
        ...
        public ViewModel(AppComponent appComponent) {
            ...
            //temp refresh
            fleetInfo.refreshDeviceInfo();
            fleetInfo.refreshDriverInfo();
        }
...
//            mGoCoderSDKPrefs = new GoCoderSDKPrefs();
        ...
        /**
         * lấy thông tin tín hiệu live
         */
        @Override
        public void queryLiveSignal(String sn, double rsrp) {
