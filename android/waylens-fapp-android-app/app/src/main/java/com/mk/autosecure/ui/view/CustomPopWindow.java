...
/**
 * Created by DoanVT on 2017/12/28.
...
public class CustomPopWindow implements PopupWindow.OnDismissListener{
    ...
    private PopupWindow build(){
        ...
        if(mWidth != 0 && mHeight!=0 ){
            ...
            mPopupWindow = new PopupWindow(mContentView, (int)(mWindow.getWindowManager().getDefaultDisplay().getWidth() * 0.75f), ViewGroup.LayoutParams.WRAP_CONTENT);
        }
            ...
            mPopupWindow.setTouchInterceptor(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if ((event.getAction() == MotionEvent.ACTION_DOWN)
                        ...
                        Logger.t(TAG).d("out side ");
                        Logger.t(TAG).d("width:"+mPopupWindow.getWidth()+"height:"+mPopupWindow.getHeight()+" x:"+x+" y  :"+y);
                        return true;
