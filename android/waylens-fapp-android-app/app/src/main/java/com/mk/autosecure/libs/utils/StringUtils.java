...
public final class StringUtils {
    ...
    private static final Pattern PLATENO = Pattern.compile("^[0-9]{2}[A-Z|a-z][0-9]{4,5}$");
    ...
    public static boolean isPlateNoValid(final  @Nullable String plateNo){
        return !TextUtils.isEmpty(plateNo) && PLATENO.matcher(plateNo).matches();
    }

    public static boolean isPhoneValid(final @NonNull String phone){
    ...
    public static String getTimeFromString(String time, final @NonNull String defaultMsg) {
        if(time == null || time.equals("")) return defaultMsg;
        String temp = "";
