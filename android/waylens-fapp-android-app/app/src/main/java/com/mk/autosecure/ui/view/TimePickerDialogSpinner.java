...
public class TimePickerDialogSpinner extends TimePickerDialog {
     ...
     */
    public TimePickerDialogSpinner(Context context, OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
     ...
     * @param is24HourView Whether this is a 24 hour view, or AM/PM.
     */
    public TimePickerDialogSpinner(Context context, int themeResId, OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
