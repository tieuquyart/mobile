...
import static com.mkgroup.camera.command.EvCameraCmdConsts.MK.CMD_MK_SEND_FACE_IMG;
...
import static com.mk.autosecure.model.ClipPosChangeEvent.INTENT_LIVE;
import static com.mk.autosecure.model.ClipPosChangeEvent.INTENT_PLAY;
import static com.mk.autosecure.model.ClipPosChangeEvent.INTENT_SHOW_THUMBNAIL;
...
@SuppressLint({"CheckResult", "NewApi", "NonConstantResourceId"})
@RequiresActivityViewModel(VideosActivityViewModel.ViewModel.class)
public class VideosActivity extends BaseActivity<VideosActivityViewModel.ViewModel> implements LiveMenuFragment.LiveMenuFragmentInterface {

    public static final String TAG = VideosActivity.class.getSimpleName();
...
//    public Toolbar toolbar4K;

    @BindView(R.id.iv_curStatus)
    ImageView iv_curStatus;

    @BindView(R.id.iv_curStatus_4k)
    ImageView ivCurStatus4K;
...
//    ImageView ivGuideSwitch;
    ...
    ImageButton btnStream_land;

    @BindView(R.id.btnStream_port)
    ImageButton btnStream_port;
...
//    ImageView imgSc;
    ...
    public void switchFaceId() {
        ...
        if (liveMenuFragment.isVisible()) {
            //
            try {
                getSupportFragmentManager().beginTransaction()
                        .hide(liveMenuFragment)
                        .show(faceIdFragment)
                        .commit();
            } catch (Exception ex) {
    ...
    public void onVideoSurfaceClicked() {
    ...
    public void onCloudSurfaceClicked() {
    ...
    public void onBitmapSurfaceClicked() {
    ...
    public void switchRecording(boolean isChecked) {
    ...
    public void onDownloadHighlight() {
    ...
    public void btnStream() {
        if (playbackUrl != null) {
            ...
            if (stream == STREAM_MAIN) {
                ...
                btnStream_port.setBackgroundResource(R.drawable.bg_sd_selector);
                btnStream_land.setBackgroundResource(R.drawable.bg_sd_selector);
            } else {
                viewModel.inputStreamIndex(0);
                btnStream_port.setBackgroundResource(R.drawable.bg_hd_selector);
                btnStream_land.setBackgroundResource(R.drawable.bg_hd_selector);
            }
            if (mClipPos != null) {
...
//    }
    ...
    /**
     * Gửi ảnh xuống camera để MOC
     *
     * @param bitmap Lấy bitmap trả về từ handler live
     */
    public void getBitmapLive(Bitmap bitmap) {
        ...
        AlertDialog.Builder alertadd = new AlertDialog.Builder(VideosActivity.this);
        LayoutInflater factory = LayoutInflater.from(VideosActivity.this);
        ...
        alertadd.setNeutralButton("Gửi xuống Camera!", (dlg, sumthin) -> {
            ...
            if (bitmap != null) {
                ...
                mEVCamera.sendImageWithMK(sendIMG, CMD_MK_SEND_FACE_IMG);
                RxBus.getDefault().toObservable(TCVNEvent.class)
                        ...
                        .subscribe(event -> {
                            ...
                            imgSCBitmap = null;
                            isScreenshot = false;
                            Toast.makeText(VideosActivity.this, event.getMsgSuccess().isParam() ? "Gửi thành công" : "Gửi thất bại", Toast.LENGTH_SHORT).show();
                        }, throwable -> {
                            hideLoadingDialog();
                            isScreenshot = false;
                            imgSCBitmap = null;
                ...
                Toast.makeText(VideosActivity.this, "Bitmap null", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void btnProjection() {
        ...
        if (switchMode != -1) {
            mVRLibrary.switchProjectionMode(VideosActivity.this, switchMode);
            mVRVideoLibrary.switchProjectionMode(VideosActivity.this, switchMode);
            mVRCloudLibrary.switchProjectionMode(VideosActivity.this, switchMode);
        }
    }
    ...
    public boolean exportClick(MotionEvent event) {
        ...
        if (videosFragment != null) {
            ...
            if (posClip != null) {
                ...
                tv_export_info.setText(String.format(Locale.US, "%s · %s",
                        VideoEventType.dealEventType(this, videoType),
...
//        }
        ...
        va_guide.findViewById(R.id.tv_skip_info).setOnClickListener(v -> {
            popSkipGuide(GUIDE_STEP.EXPORT_INFO);
        });
            ...
            va_guide.findViewById(R.id.layout_guide_detail)
                    .findViewById(R.id.btn_go_guide).setOnClickListener(v1 -> {
                        ...
                        va_guide.findViewById(R.id.btn_complete).setOnClickListener(v11 -> {
                            ...
                            LocalLiveActivity.launch(VideosActivity.this, true);
                        });
                    });
        });
        return true;
    ...
    public static void launch(Activity activity, String sn, boolean guide) {
        ...
        intent.putExtra(IntentKey.TOUR_GUIDE, guide);
        activity.startActivity(intent);
    }

    public static void launch(Activity activity, String sn, long startTimeMs) {
        Intent intent = new Intent(activity, VideosActivity.class);
        intent.putExtra(IntentKey.SERIAL_NUMBER, sn);
        intent.putExtra(IntentKey.START_TIME_MS, startTimeMs);
        activity.startActivity(intent);
    }
...
//        preview.setVisibility(View.GONE);
        ...
        mStartTimeMs = getIntent().getLongExtra(IntentKey.START_TIME_MS, -1);
...
//        intervalCheck();
        ...
        if (mStartTimeMs != -1) {
            if (videosFragment != null) {
                Menu menu = toolbar.getMenu();//mCamera.getNeedDewarp() ? toolbar.getMenu() : toolbar4K.getMenu();
...
//                toolbar4K.setVisibility(View.VISIBLE);
                btnEvCamStreamPort.setVisibility(View.INVISIBLE);
                btnEvCamStreamLand.setVisibility(View.INVISIBLE);
                ivCurStatus4K.setImageResource(R.drawable.icon_live_view);
                tv_toolbarTitle.setText(sn);
//                tvToolbarTitle4K.setText(R.string.to_live);
            } else {
                String[] descriptions = mClipPos.clip.descriptions;
                int length = mClipPos.clip.streams.length;
                Logger.t(TAG).d("descriptions: " + Arrays.toString(descriptions) + " " + length);
...
//                    Logger.t(TAG).d("selected: " + data.indexOf(item));
    ...
    GuideLayout projectionLayout;
//    GuideLayout pinchLayout;
    ...
    private void initView() {
        /*if (tourGuide) {
            View projectionView = LayoutInflater.from(this).inflate(R.layout.view_switch_projection, null);
            ...
            View pinchView = LayoutInflater.from(this).inflate(R.layout.include_guide_skiporgo, null);
...
//                            }
                            ...
                            findViewById(R.id.btn_go_guide).setVisibility(View.GONE);
                            findViewById(R.id.tv_skip_guide).setOnClickListener(v -> {
...
//                                Logger.t(TAG).d("export Thumbnail: " + x + " " + y);
                                ...
                                if (videosFragment != null) {
                                    ...
                                    Glide.with(VideosActivity.this)
                                            ...
                                            //.override(256, 256)
                                            .transform(new TwoDirectionTransform(VideosActivity.this, posClip.isLensNormal()))
        ...
        if (Constants.isFleet() && mCamera != null && mCamera.getHardwareModel() == ICameraWrapper.Model.TW06 && mCamera.isCalibCameraAvailable()) {
            ...
            liveMenuFragment = LiveMenuFragment.newInstance(sn, this);
            transaction.add(R.id.frameLayout, liveMenuFragment);
            transaction.show(liveMenuFragment);
...
//                    ll_pinch_drag.setVisibility(View.GONE);
    ...
    private void initPlayControl() {
        Action mControlPanelAction = () -> {
            if (VideosActivity.this.isFullScreen()) {
                VideosActivity.this.hideControlPanel();
                VideosActivity.this.setImmersiveMode(true);
            }
        };
...
//                Logger.t(TAG).d("%s", "new clip changed");
    ...
    private void showPopWindow(int layoutId, boolean cancel) {
        ...
        Glide.with(this)
                ...
                .load(clipPos)
                .transform(new TwoDirectionTransform(this, clip.isLensNormal()))
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .crossFade()
                .into(iv_scene);
...
//            Logger.t(TAG).d("exoPlayer checkProgress: " + viewModel.isLiveOrNot);
    ...
    public void onCameraStateChangeEvent(CameraStateChangeEvent event) {
            ...
            switch (recordState) {
                ...
                case VdtCamera.STATE_RECORD_STOPPED:
                    if (viewModel.isLiveOrNot) {
                        ...
                        ivCurStatus4K.setImageDrawable(null);
                    }
//                    if (!isFullScreen()) {
...
//            iv_batteryStatus.setVisibility(View.INVISIBLE);
        }
    }
    ...
    private void onClipPosChangeEvent(ClipPosChangeEvent event) {
        if (event.getPublisher().equals(VideosFragment.class.getSimpleName())) {
            ...
            if (event.getClipPos() != null) {
                ...
                if (event.getIntent() == INTENT_PLAY) {
//                    Logger.t(TAG).d("ClipPosChangeEvent INTENT_PLAY: " + event.getClipPos().getClipTimeMs());
                ...
                } else if (event.getIntent() == INTENT_SHOW_THUMBNAIL) {
...
//                    viewModel.fetchThumbnail(clipPos);
            ...
            } else if (event.getIntent() == INTENT_LIVE && mCamera != null) {
...
//                fetchThumbnail(eventBean.thumbnail, false);
    ...
    private void switchProjection(MDVRLibrary library, boolean isLensNormal) {
        ...
        if (switchMode != -1) {
            library.switchProjectionMode(VideosActivity.this, switchMode);
        }
    }
    ...
    private void showPlayButton(boolean isCloud) {
        if (!isCloud) {
            ...
            tv_toolbarTitle.setText(R.string.sdcard);

            iv_videoSrc.setImageResource(R.drawable.icon_sdcard);
            tv_videoSrc.setText(R.string.sdcard);

            ivCurStatus4K.setImageResource(R.drawable.icon_sdcard);
//            tvToolbarTitle4K.setText(R.string.sdcard);

            btn_highlight.setVisibility(Constants.isFleet() ? View.INVISIBLE : View.VISIBLE);

//            btnStream_port.setVisibility(View.VISIBLE);
//            btnStream_land.setVisibility(View.VISIBLE);
            ...
            ivCurStatus4K.setImageResource(R.drawable.icon_cloud);
//            tvToolbarTitle4K.setText(R.string.cloud);

            btn_highlight.setVisibility(View.INVISIBLE);

            btnStream_port.setVisibility(View.INVISIBLE);
            btnStream_land.setVisibility(View.INVISIBLE);
        }
    ...
    private void adaptationForLandscape() {
        ...
        Logger.t(TAG).i("totalWidth: " + totalWidth + " totalHeight: " + totalHeight
        ...
        if (totalWidth * mYRadio >= totalHeight * mXRadio) {
            mMediaWindow.post(() -> {
                ...
                Logger.t(TAG).i("marginStart: " + marginStart + " marginEnd: " + marginEnd);
...
//                int height = tvNotRecording.getVisibility() == View.VISIBLE ? ViewUtils.dp2px(27) : 0;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        mVRVideoLibrary.onOrientationChanged(this);
        mVRCloudLibrary.onOrientationChanged(this);
...
//                }
        ...
        simpleExoPlayer.addListener(new Player.EventListener() {
            ...
            public void onPlayerError(ExoPlaybackException error) {
                ...
                Toast.makeText(VideosActivity.this, R.string.play_error, Toast.LENGTH_SHORT).show();
            }
...
//                    + "--ClipTimeMs" + clipPos.getClipTimeMs());
            ...
            Observable.create((ObservableOnSubscribe<Void>) emitter -> {
                        try {
                            ...
                            Logger.t(TAG).d("mStreamIndex: " + viewModel.mStreamIndex + " " + length);
...
//                        playbackUrl.url = "http://192.168.110.1:8085/clip/0/5ee7738d/3/18682947-962167-0-0-0.m3u8";
...
//                        mMediaPlayerWrapper.openRemoteFile("rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov");
    ...
    public void refreshPipeline(CameraWrapper wrapper) {
    ...
    synchronized private void loadMJPEG() {
        try {
            if (mjpegAddress != null && mMjpegStream == null) {
                ...
                iv_curStatus.setImageResource(R.drawable.icon_live_view);
                tv_toolbarTitle.setText(!StringUtils.isEmpty(sn) ? sn : getString(R.string.to_live));
...
//        }
    ...
    protected MDVRLibrary createBitmapVRLibrary() {
    ...
    protected MDVRLibrary createVideoVRLibrary() {
        return MDVRLibrary.with(this)
                ...
                .ifNotSupport(mode -> {
                    ...
                    Toast.makeText(VideosActivity.this, tip, Toast.LENGTH_SHORT).show();
                })
                ...
                .build((GLSurfaceView) findViewById(R.id.gl_videoView));
    }

    protected MDVRLibrary createCloudLibrary() {
        return MDVRLibrary.with(this)
                .displayMode(MDVRLibrary.DISPLAY_MODE_NORMAL)
                .interactiveMode(MDVRLibrary.INTERACTIVE_MODE_TOUCH)
                .asVideo(surface -> {
                ...
                .projectionFactory(new CustomProjectionFactory())
                .barrelDistortionConfig(new BarrelDistortionConfig().setDefaultEnabled(false).setScale(0.95f))
                .build((GLSurfaceView) findViewById(R.id.gl_cloudView));
    }
...
//        if (viewModel.isLiveOrNot && mjpegAddress != null) startStream(mjpegAddress);
    ...
    private void onNewCamera(CameraWrapper camera) {
        ...
        if (!TextUtils.isEmpty(sn) && sn.equals(camera.getSerialNumber())) {
            mCamera = camera;
            adaptationFor4K(camera.getNeedDewarp(), true);
            checkSomeMsg(camera);
            initMsgEvent();
            if (viewModel.isLiveOrNot) {
                refreshPipeline(camera);
            }
        } else {
            onDisconnectCamera();
        }
    ...
    private void onInfoMsgQueue(InfoMsgQueue imq) {
        ...
        if (msg != null) {
            ...
            if (tourGuide || setup) {
                //do sth
            } else if (!msg.isRead() && isForeground) {
                showPopBottom(msg);
            }
        }
    }
    ...
    private void showPopBottom(InfoMsgQueue.InfoMsg infoMsg) {
        ...
        llMessage.setBackgroundColor(InfoMsgUtils.getInstance().getColor(this, infoMsg.getType()));
        tvContent.setText(InfoMsgUtils.getInstance().getMessage(this, infoMsg.getType()));


        String action = InfoMsgUtils.getInstance().getAction(this, infoMsg.getType());
        if (TextUtils.isEmpty(action)) {
            ...
            ibAction
                    .setOnClickListener(v -> {
                        if (mCamera != null) {
                            InfoMsgUtils.getInstance().clickAction(this, mCamera.getSerialNumber(), infoMsg.getType());
                        }
                        llMessage.setVisibility(View.GONE);
                    });
        }
    ...
    private void onDisconnectCamera() {
        ...
        ivCurStatus4K.setImageResource(R.drawable.icon_home_offline);
        mCamera = null;
        stopStream();
    ...
    public MDVRLibrary getVRCloudLibrary() {
    ...
    public void setupToolbar() {
        ...
        toolbar.setNavigationOnClickListener(v -> {
            Logger.t(TAG).d("liveMenu: " + liveMenuFragment.isVisible() + " video: " + videosFragment.isVisible() + "remote: " + remoteVideoFragment.isVisible());
            if (videosFragment != null && videosFragment.isVisible()) {
                ...
                videosFragment.onToLiveClick();
                btnEvCamFaceId.setVisibility(View.VISIBLE);
            } else /*if (liveMenuFragment != null && liveMenuFragment.isVisible()) */{
                finish();
            }
        });
//        toolbar4K.setNavigationOnClickListener(v -> finish());
...
//                        remoteVideoFragment.onToLiveClick();
//                    }
//                    DevicesActivity.launch(VideosActivity.this, mCamera.getSerialNumber());
//                }
//            }
//            return false;
//        });
...
//        Logger.t(TAG).d("refreshHighlightButton: " + viewModel.isLiveOrNot + " " + clipPos);
...
//        Logger.t(TAG).d("scaleView targetHeight = " + targetHeight);
    ...
    static class RefreshHandler extends Handler {
        ...
        private final WeakReference<VideosActivity> weakReference;

        RefreshHandler(VideosActivity activity) {
            weakReference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            VideosActivity activity = weakReference.get();
            if (activity != null
                    && activity.mCamera != null && activity.mCamera.getClipsManager() != null
                    && activity.videosFragment != null && activity.videosFragment.viewModel() != null) {
                //在highlight export时不刷新
                if (activity.pb_highlight.getVisibility() != View.VISIBLE) {
                    activity.mCamera.getClipsManager().updateClip((Clip) msg.obj, false);
                    activity.videosFragment.viewModel().loadClips(activity.filterList, true);
                }
            }
        }
    }
    ...
    private void showHighlightSuccessDialog() {
        View view = LayoutInflater.from(this).inflate(R.layout.pop_highlight_success, null);
...
//        }
    ...
    private void shakeAnim(View view, float shakeDegrees, long duration) {
        if (view == null) {
            return;
        }
...
//                Keyframe.ofFloat(0.9f, -shakeDegrees),
    ...
    private void showStreamDialog() {
        View view = LayoutInflater.from(this).inflate(R.layout.layout_switch_stream, null);
    ...
    @Override
    public void onLoginFaceCallback(int id) {
        switch (id) {
            case R.id.ll_login_face:
                //onLoginFace click callback from liveMenuFragment to Activity
                isScreenshot = true;
                getBitmapLive(imgSCBitmap);
                break;
            case R.id.rl_data_sdcard:
                if (liveMenuFragment != null && liveMenuFragment.isVisible()) {
                    try {
                        getSupportFragmentManager().beginTransaction()
                                .hide(liveMenuFragment)
                                .show(videosFragment)
                    ...
                    videosFragment.onToLiveClick();
                    btnEvCamFaceId.setVisibility(View.GONE);
                }
                break;
            case R.id.rl_base_info:
                showLoadingDialog();
                CustomMK customMK = new CustomMK("msg01");
                mEVCamera.setAdasCfgInfoWithMK(customMK, CMD_MK_TCVN01);
                ...
                RxBus.getDefault().toObservable(TCVNEvent.class)
                        ...
                        .subscribe(tcvn01Event -> {
                            ...
                            hideLoadingDialog();
                            TCVNActivity.launch(this, tcvn01Event.getModel01());
                        }, new ServerErrorHandler(TAG));

                break;
            case R.id.rl_check_sim_card:
                showLoadingDialog();
                mEVCamera.checkCarrier();
                RxBus.getDefault().toObservable(TCVNEvent.class)
                        .compose(bindToLifecycle())
                        .takeUntil(Observable.error(new TimeoutException()).delay(30, TimeUnit.SECONDS, true))
                        ...
                        .subscribe(event -> {
                            ...
                            hideLoadingDialog();
                            CheckSimDataActivity.launch(this, event.getCarrierBean());
                        }, throwable -> {
                            hideLoadingDialog();
                            CheckSimDataActivity.launch(this);
                            Toast.makeText(this, "check Carrier lỗi", Toast.LENGTH_SHORT).show();
                            new ServerErrorHandler(TAG);
                        });
                break;
            case R.id.rl_get_log:
                ReportLogActivity.launch(this);
                break;
            case R.id.rl_config_login_face:
                Observable
                        .create((ObservableOnSubscribe<Optional<PopupWindow>>) emitter -> {
                            View view = LayoutInflater.from(this).inflate(R.layout.popup_cfg_login_face, null);
                        ...
                        .compose(Transformers.switchSchedulers())
                        .compose(bindToLifecycle())
                        .subscribe(windowOptional -> windowOptional.get().showAsDropDown(frameLayout));
                break;
        }
    }
}
