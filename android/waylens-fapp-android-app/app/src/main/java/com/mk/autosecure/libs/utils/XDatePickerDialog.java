 ...
 */
public class XDatePickerDialog extends DialogFragment implements
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(XDatePickerDialog view, int year, int monthOfYear, int dayOfMonth, int yearEnd, int monthOfYearEnd, int dayOfMonthEnd);
    }
     ...
     */
    public static XDatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                                int monthOfYear,
                                                int dayOfMonth) {
        XDatePickerDialog ret = new XDatePickerDialog();
     ...
     */
    public static XDatePickerDialog newInstance(OnDateSetListener callBack,
                                                int year,
                                                int monthOfYear,
                                                int dayOfMonth,
                                                int yearEnd,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.borax12.materialdaterangepicker.R.layout.range_date_picker_dialog, null);

        tabHost = (TabHost) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_tabHost);
        tabHost.findViewById(com.borax12.materialdaterangepicker.R.id.range_tabHost);
        tabHost.setup();

        final Activity activity = getActivity();

        TabHost.TabSpec startDatePage = tabHost.newTabSpec("start");
        startDatePage.setContent(com.borax12.materialdaterangepicker.R.id.start_date_group);
        startDatePage.setIndicator((startTitle != null && !startTitle.isEmpty()) ? startTitle : activity.getResources().getString(com.borax12.materialdaterangepicker.R.string.range_from));

        TabHost.TabSpec endDatePage = tabHost.newTabSpec("end");
        endDatePage.setContent(com.borax12.materialdaterangepicker.R.id.range_end_date_group);
        endDatePage.setIndicator((endTitle != null && !endTitle.isEmpty()) ? endTitle : activity.getResources().getString(com.borax12.materialdaterangepicker.R.string.range_to));

        tabHost.addTab(startDatePage);
        tabHost.addTab(endDatePage);

        mDayOfWeekView = (TextView) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_header);
        mMonthAndDayView = (LinearLayout) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_month_and_day);
        mMonthAndDayViewEnd = (LinearLayout) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_month_and_day_end);
        mMonthAndDayView.setOnClickListener(this);
        mMonthAndDayViewEnd.setOnClickListener(this);

        mSelectedMonthTextView = (TextView) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_month);
        mSelectedMonthTextViewEnd = (TextView) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_month_end);

        mSelectedDayTextView = (TextView) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_day);
        mSelectedDayTextViewEnd = (TextView) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_day_end);

        mYearView = (TextView) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_year);
        mYearViewEnd = (TextView) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_date_picker_year_end);
        ...
        mDayPickerDescription = res.getString(com.borax12.materialdaterangepicker.R.string.range_day_picker_description);
        mSelectDay = res.getString(com.borax12.materialdaterangepicker.R.string.range_select_day);
        mYearPickerDescription = res.getString(com.borax12.materialdaterangepicker.R.string.range_year_picker_description);
        mSelectYear = res.getString(com.borax12.materialdaterangepicker.R.string.range_select_year);

        int bgColorResource = mThemeDark ? com.borax12.materialdaterangepicker.R.color.range_date_picker_view_animator_dark_theme : com.borax12.materialdaterangepicker.R.color.range_date_picker_view_animator;
        view.setBackgroundColor(ContextCompat.getColor(activity, bgColorResource));

        mAnimator = (com.borax12.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_animator);
        mAnimatorEnd = (com.borax12.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_animator_end);
        ...
        Button okButton = (Button) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_ok);
        ...
        Button cancelButton = (Button) view.findViewById(com.borax12.materialdaterangepicker.R.id.range_cancel);
        ...
        if (mAccentColor != -1) {
            ...
            view.findViewById(com.borax12.materialdaterangepicker.R.id.range_day_picker_selected_date_layout).setBackgroundColor(mAccentColor);
            view.findViewById(com.borax12.materialdaterangepicker.R.id.range_day_picker_selected_date_layout_end).setBackgroundColor(mAccentColor);
    ...
    private void checkDateValidity() {
        ...
        long timeInMillisEnd = mCalendarEnd.getTimeInMillis();
        if (timeInMillisEnd < timeInMillis) {
            Toast.makeText(getContext(), "Date is illegal, please re-select!", Toast.LENGTH_SHORT).show();
        } else {
            if (mCallBack != null) {
                mCallBack.onDateSet(XDatePickerDialog.this, mCalendar.get(Calendar.YEAR),
    ...
    public Calendar getMaxDate() {
        Calendar tempMaxCalendar = Calendar.getInstance(this.mCalendar.getTimeZone());
        tempMaxCalendar.setTimeInMillis(this.mCalendar.getTimeInMillis());
        tempMaxCalendar.add(Calendar.DAY_OF_MONTH, 13);

        if (mMaxDate.getTimeInMillis() > tempMaxCalendar.getTimeInMillis()) {

            if (mCalendarEnd.getTimeInMillis() > tempMaxCalendar.getTimeInMillis()) {
                mCalendarEnd.setTimeInMillis(tempMaxCalendar.getTimeInMillis());
    ...
    public void onClick(View v) {
        tryVibrate();
        if (v.getId() == com.borax12.materialdaterangepicker.R.id.range_date_picker_year || v.getId() == com.borax12.materialdaterangepicker.R.id.range_date_picker_year_end) {
            setCurrentView(YEAR_VIEW);
        } else if (v.getId() == com.borax12.materialdaterangepicker.R.id.range_date_picker_month_and_day || v.getId() == com.borax12.materialdaterangepicker.R.id.range_date_picker_month_and_day_end) {
    ...
    public void onDayOfMonthSelected(int year, int month, int day) {
        ...
        if (mCalendarEnd.getTimeInMillis() < mCalendar.getTimeInMillis()) {
            mCalendarEnd.setTimeInMillis(mCalendar.getTimeInMillis());
        }
