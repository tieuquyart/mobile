package com.mk.autosecure.ui.view.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final float DEFAULT_ANCHOR_POINT = 0.4f; // In relative %
    ...
    public interface PanelSlideListener {
         ...
         */
        public void onPanelStateChanged(View panel, PanelState previousState, PanelState newState, float slideOffset);
    }
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mPanelHeight == -1) {
            mPanelHeight = (int) (DEFAULT_PANEL_HEIGHT * density + 0.4f);
        }
        if (mShadowHeight == -1) {
            mShadowHeight = (int) (DEFAULT_SHADOW_HEIGHT * density + 0.4f);
        }
        ...
        mDragHelper = ViewDragHelper.create(this, 0.4f, scrollerInterpolator, new DragHelperCallback());
    ...
    void dispatchOnPanelStateChanged(View panel, PanelState previousState, PanelState newState) {
        synchronized (mPanelSlideListeners) {
            for (PanelSlideListener l : mPanelSlideListeners) {
                l.onPanelStateChanged(panel, previousState, newState, mSlideOffset);
            }
        }
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (direction > 0 && mSlideOffset <= mAnchorPoint) {
                ...
                target = computePanelTopPosition(0.85f);
            } else if (direction < 0 && mSlideOffset >= mAnchorPoint) {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            ...
            final int expandedTop = computePanelTopPosition(0.85f);
            if (mIsSlidingUp) {
