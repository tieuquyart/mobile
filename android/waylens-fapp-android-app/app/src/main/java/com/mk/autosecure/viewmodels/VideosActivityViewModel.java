...
public interface VideosActivityViewModel {
    ...
    final class ViewModel extends ActivityViewModel<VideosActivity> implements Inputs, Outputs {
        ...
        /**
         * khởi tạo user, nhận thông tin event ClipPos
         * */
        ...
        /**
         * Lấy thông tin bitmap từ ClipPos
         * */
        @SuppressLint("CheckResult")
...
//                            Logger.t(TAG).d("处理请求结束");
        ...
        public final VideosActivityViewModel.Inputs inputs = this;

        public final VideosActivityViewModel.Outputs outputs = this;
        ...
        /**
         * fetch thumbnail with thumbnail url
         * */
        @Override
        ...
        public void download(Clip oneClip, int duration, long offset) {
            ...
            DownloadJob job = new DownloadJob(mContext, duration, offset, clip, clip.streams[0], Clip.STREAM_MAIN);
            job.setTranscode(false);
//            job.setAngle(angle);
//            job.setFullScreen(fullScreen);
//            job.setEnableTime(enableTime);
            job.setExportEventTag(VideosActivity.TAG);
