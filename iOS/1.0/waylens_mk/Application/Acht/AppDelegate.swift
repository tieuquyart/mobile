...
private extension AppDelegate {
    ...
    //        BITHockeyManager.shared().configure(withBetaIdentifier: Constants.AccessKeys.hockeyAppIDForBeta, liveIdentifier: Constants.AccessKeys.hockeyAppIDForLive, delegate: self)
    //        BITHockeyManager.shared().crashManager.setAlertViewHandler {
    //            let alert = UIAlertController(
    //                title: NSLocalizedString("App Crashed", comment: "App Crashed"),
    //                message: NSLocalizedString("Send crash report to developers. Thanks!", comment: "Send crash report to developers. Thanks!"),
    //                preferredStyle: .alert
    //            )
    //            alert.addTextField(configurationHandler: { (textField) in
    //                textField.placeholder = NSLocalizedString("How to reproduce this crash?", comment: "How to reproduce this crash?")
    //            })
    //            alert.addAction(UIAlertAction(title: NSLocalizedString("Send", comment: "Send"), style: .default, handler: { (_) in
    //                let metaData = BITCrashMetaData()
    //                metaData.userProvidedDescription = alert.textFields?[0].text
    //                if AccountControlManager.shared.isAuthed {
    //                    metaData.userID = AccountControlManager.shared.keyChainMgr.userID
    //                    metaData.userName = AccountControlManager.shared.keyChainMgr.displayName
    //                    //metaData.userEmail = AccountControlManager.shared.keyChainMgr.email
    //                }
    //                BITHockeyManager.shared().crashManager.handle(.send, withUserProvidedMetaData: metaData)
    //            }))
    //            alert.addAction(UIAlertAction(title: NSLocalizedString("Always Send", comment: "Always Send"), style: .default, handler: { (_) in
    //                let metaData = BITCrashMetaData()
    //                metaData.userProvidedDescription = alert.textFields?[0].text
    //                if AccountControlManager.shared.isAuthed {
    //                    metaData.userID = AccountControlManager.shared.keyChainMgr.userID
    ...
    //                    //metaData.userEmail = AccountControlManager.shared.keyChainMgr.email
    //                }
    //                BITHockeyManager.shared().crashManager.handle(.alwaysSend, withUserProvidedMetaData: metaData)
    //            }))
    //            alert.addAction(UIAlertAction(title: NSLocalizedString("Cancel", comment: "Cancel"), style: .cancel, handler: { (_) in
    //                BITHockeyManager.shared().crashManager.handle(.dontSend, withUserProvidedMetaData: BITCrashMetaData())
    //            }))
