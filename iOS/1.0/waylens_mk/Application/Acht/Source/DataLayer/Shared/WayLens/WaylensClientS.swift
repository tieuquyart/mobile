...
//    }
    ...
    func report(_ detail:String?, camera:UnifiedCamera?, logFile:URL?, completion: completionBlock?) {
        ...
        var params: [String: String]? = [
            ...
            "agentOS": UIDevice.current.systemVersion,
        ...
        #if FLEET
        if !AccountControlManager.shared.keyChainMgr.email.isEmpty {
            params?["email"] = AccountControlManager.shared.keyChainMgr.email
        }
