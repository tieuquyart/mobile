...
//        self.genderTf.text = "Nữ"
    ...
    override func viewDidLoad() {
        ...
        ConstantMK.borderTF([driverNameTf,phoneNumberTf,idNumberTf,driverLicenseTf,valid_until_tf, codeDriver])
    }
 ...
 //   var formattedDate: String? = ""
    ...
    @objc private func dateChanged(picker : UIDatePicker) {
        ...
        self.valid_until_tf.text = date.toString(format: .isoDate)
        self.onDoneClicked()
    ...
    func add() {
        model = ParamDriver(drivingYears: valid_until_tf.text! ,  employeeId: codeDriver.text!, gender: 0, idNumber: idNumberTf.text!, license: driverLicenseTf.text!, licenseType: btnShowView.infoLabel.text!, name: driverNameTf.text!, phoneNo: phoneNumberTf.text!)
    ...
    func change() {
        ...
        let model =  ParamDriver(drivingYears: valid_until_tf.text!  , employeeId: codeDriver.text!, gender: 0, idNumber: idNumberTf.text!, license: driverLicenseTf.text!, licenseType: btnShowView.infoLabel.text!, name: driverNameTf.text!, phoneNo: phoneNumberTf.text!)
