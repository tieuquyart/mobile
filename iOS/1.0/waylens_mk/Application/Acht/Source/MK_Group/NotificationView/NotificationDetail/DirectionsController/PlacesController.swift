...
//    lazy var infoButton = UIButton(type: .infoLight)
    ...
    let categoryLabel =  UILabel(text: "Phân loại", font: .boldSystemFont(ofSize: 16))
    let eventTypeLabel =  UILabel(text: "Hành vi", font: .boldSystemFont(ofSize: 16))
    let fleetNameLabel =  UILabel(text: "Tên Fleet", font: .boldSystemFont(ofSize: 16))
    let plateNoLabel =  UILabel(text: "Biển số xe", font: .boldSystemFont(ofSize: 16))
    let timeLabel =  UILabel(text: "Thời gian", font: .boldSystemFont(ofSize: 16))



//    func setTitle(title : String , info : String?) {
//
...
//
//        attributedTextEventType.append(NSAttributedString(string: "/n(NSLocalizedString(info ?? "null")", comment: info ?? "null")  , attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 14)]))
//
//        attributedText = attributedTextEventType
//
//    }
