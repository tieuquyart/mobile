...
//        dmsInfoLabel.font = UIFont.systemFont(ofSize: view.bounds.height / 30)
    }
...
extension PlayerPanel {
    ...
    private func titleAttribute() -> [NSAttributedString.Key : Any] {
        return [ .foregroundColor : UIColor(rgb: 0xC5C5C5, a: 1.0),
                 ...
                 .font : UIFont.systemFont(ofSize: view.bounds.height / 36) ]
    }
    private func normalAttribute() -> [NSAttributedString.Key : Any] {
        return [ .foregroundColor : UIColor.white,
                 .strokeWidth : -0.1,
                 .strokeColor : UIColor.black,
                 .font : UIFont.boldSystemFont(ofSize: view.bounds.height / 36) ]
    }
