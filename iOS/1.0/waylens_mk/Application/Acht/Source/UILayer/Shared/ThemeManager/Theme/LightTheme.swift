...
final class LightTheme: ThemeProtocol {
    ...
    private var navigationBarAppearance: UINavigationBarAppearance {
        ...
        appearance.backgroundColor = color(forSemanticColor: .background(.primary))
        appearance.titleTextAttributes = [.foregroundColor : UIColor(rgb: 0x344254), .font:UIFont.boldSystemFont(ofSize: 14)]
    ...
    var appearanceRules: AppearanceRuleSet {
        return AppearanceRuleSet {
            ...
            if #available(iOS 15.0, *) {
                ...
                UINavigationBar[\.titleTextAttributes, [.foregroundColor : UIColor(rgb: 0x344254), .font:UIFont.boldSystemFont(ofSize: 14)]]
                ...
                UINavigationBar[
                    ...
                    value: color(forSemanticColor: .background(.primary)).toImage()
                ]
            }
            ...
            UIBarButtonItem[
                ...
                value: [
                    NSAttributedString.Key.font: font(forStyle: .subhead(attribute: .medium)),
