...
//    @IBOutlet weak var viewFull: UIView!
    ...
    static func createViewController(camera: UnifiedCamera?, dateScrollTo: Date? = nil, isCameraPickerEnabled: Bool = false) -> HNCameraDetailViewController {
...
//
    ...
    func setViewTimeline() {
        if self.isTapDataMemorySDView {
            ...
            viewContainerConfigCameraMK.isHidden = true
    ...
    func configGrayButtonMK() {
        ...
        self.dataMemorySDView.setTitle(str: "Dữ liệu thẻ SD", imageStr: "videogray")
        self.informationBasicView.setTitle(str: "Thông tin cơ bản", imageStr: "bookgray")
        self.checkSimCardView.setTitle(str: "Kiểm tra thẻ sim", imageStr: "smsgray")
        self.configurationView.setTitle(str: "Cấu hình", imageStr: "settinggray")
        self.reportView.setTitle(str: "Xem báo cáo", imageStr: "bookgray")
        self.checkLoginCamera.setTitle(str: "Cài đặt đăng nhập", imageStr: "settinggray")
...
//        playerPanel.timeLineHorizontalView = nil
        ...
        if let code =  notification.userInfo?["code"] as? Int {
            if code == 2000 {
                if let data = notification.userInfo?["data"] as? [String: Any] {
                    ...
                    self.showAlert(title: "Thông báo", message: "Xóa face thành công")
                    return
                }
            } else {
    ...
    override func applyTheme() {
        ...
        view.backgroundColor = UIColor.semanticColor(.background(.septenary))
    ...
    func showTimeLineVerticalView() {
        ...
        timeLineVerticalView?.view.isHidden = false
        viewContainerConfigCameraMK?.isHidden = false
        timeline = timeLineVerticalView
        timeline?.dataSource = dataModel
    }
    ...
    func hideTimeLineVerticalView() {
        timeLineVerticalView?.view.isHidden = true
        viewContainerConfigCameraMK?.isHidden = true
    }
...
//                tabBarController: tabBarController,
    ...
    @objc func showSettingButtonIfNeeded() {
        ...
        backButton.imageInsets = UIEdgeInsets(top: 0, left: -15, bottom: 0, right: 0)
