//
//  ObserverForSecureEsNetworkSetupWay.swift
//  Fleet
//
...
class ObserverForSecureEsNetworkSetupWay: Observer {

    weak var eventResponder: ObserverForSecureEsNetworkSetupWayEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<SecureEsNetworkSetupWayViewControllerState>
    ...
    init(state: Observable<SecureEsNetworkSetupWayViewControllerState>) {
        self.state = state
    }
