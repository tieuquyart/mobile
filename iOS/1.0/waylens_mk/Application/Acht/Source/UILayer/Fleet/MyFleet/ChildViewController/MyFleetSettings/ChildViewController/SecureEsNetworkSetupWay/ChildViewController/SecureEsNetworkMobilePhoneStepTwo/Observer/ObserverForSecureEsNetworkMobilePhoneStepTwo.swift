//
//  ObserverForSecureEsNetworkMobilePhoneStepTwo.swift
//  Fleet
//
...
class ObserverForSecureEsNetworkMobilePhoneStepTwo: Observer {

    weak var eventResponder: ObserverForSecureEsNetworkMobilePhoneStepTwoEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<SecureEsNetworkMobilePhoneStepTwoViewControllerState>
    ...
    init(state: Observable<SecureEsNetworkMobilePhoneStepTwoViewControllerState>) {
        self.state = state
    }
