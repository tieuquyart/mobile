//
//  ObserverForCalibrationCameraOrientation.swift
//  Fleet
//
...
class ObserverForCalibrationCameraOrientation: Observer {

    weak var eventResponder: ObserverForCalibrationCameraOrientationEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<CalibrationCameraOrientationViewControllerState>
    ...
    init(state: Observable<CalibrationCameraOrientationViewControllerState>) {
        self.state = state
    }
