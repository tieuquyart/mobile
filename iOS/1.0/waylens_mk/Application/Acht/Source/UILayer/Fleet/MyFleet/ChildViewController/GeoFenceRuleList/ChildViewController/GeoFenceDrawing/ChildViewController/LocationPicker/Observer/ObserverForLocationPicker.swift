//
//  ObserverForLocationPicker.swift
//  Fleet
//
...
class ObserverForLocationPicker: Observer {

    weak var eventResponder: ObserverForLocationPickerEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<LocationPickerViewControllerState>
    ...
    init(state: Observable<LocationPickerViewControllerState>) {
        self.state = state
    }
