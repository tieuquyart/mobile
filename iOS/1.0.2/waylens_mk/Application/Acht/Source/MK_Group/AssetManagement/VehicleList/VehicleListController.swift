...
class VehicleListController: UIViewController {
    ...
    func customizeDropDown(view : UIView , model : VehicleItemModel) {
        ...
        chooseMoreDropDown.dataSource = ["Chỉnh Sửa", "Xóa","Phân công tài xế","Đổi camera"]
...
extension VehicleListController {
    func showAlert(_ model : VehicleItemModel) {
...
extension VehicleListController : UISearchBarDelegate {
