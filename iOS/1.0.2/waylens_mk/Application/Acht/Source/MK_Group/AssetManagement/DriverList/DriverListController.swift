...
extension UIView {
    ...
    func addShadow(location: VerticalLocation, color: UIColor = .black, opacity: Float = 0.1, radius: CGFloat = 5.0) {
        ...
        func addShadow(offset: CGSize, color: UIColor = .black, opacity: Float = 0.15, radius: CGFloat = 5.0) {
...
class DriverListController: BaseViewController {
...
extension DriverListController : UISearchBarDelegate {
