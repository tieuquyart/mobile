//
//  ObserverForPersonnelManagement.swift
//  Fleet
//
...
class ObserverForPersonnelManagement: Observer {

    weak var eventResponder: ObserverForPersonnelManagementEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<PersonnelManagementViewControllerState>
    ...
    init(state: Observable<PersonnelManagementViewControllerState>) {
        self.state = state
    }
