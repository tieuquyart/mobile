//
//  ObserverForSecureEsNetworkMobilePhoneStepThree.swift
//  Fleet
//
...
class ObserverForSecureEsNetworkMobilePhoneStepThree: Observer {

    weak var eventResponder: ObserverForSecureEsNetworkMobilePhoneStepThreeEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<SecureEsNetworkMobilePhoneStepThreeViewControllerState>
    ...
    init(state: Observable<SecureEsNetworkMobilePhoneStepThreeViewControllerState>) {
        self.state = state
    }
