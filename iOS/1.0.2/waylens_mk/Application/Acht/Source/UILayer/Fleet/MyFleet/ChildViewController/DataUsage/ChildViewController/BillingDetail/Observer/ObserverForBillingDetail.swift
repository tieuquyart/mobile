//
//  ObserverForBillingDetail.swift
//  Fleet
//
...
class ObserverForBillingDetail: Observer {

    weak var eventResponder: ObserverForBillingDetailEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<BillingDetailViewControllerState>
    ...
    init(state: Observable<BillingDetailViewControllerState>) {
        self.state = state
    }
