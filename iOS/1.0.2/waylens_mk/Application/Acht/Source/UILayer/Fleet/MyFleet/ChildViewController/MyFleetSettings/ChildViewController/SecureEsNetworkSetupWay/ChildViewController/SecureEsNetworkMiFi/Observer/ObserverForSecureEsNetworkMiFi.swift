//
//  ObserverForSecureEsNetworkMiFi.swift
//  Fleet
//
...
class ObserverForSecureEsNetworkMiFi: Observer {

    weak var eventResponder: ObserverForSecureEsNetworkMiFiEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<SecureEsNetworkMiFiViewControllerState>
    ...
    init(state: Observable<SecureEsNetworkMiFiViewControllerState>) {
        self.state = state
    }
