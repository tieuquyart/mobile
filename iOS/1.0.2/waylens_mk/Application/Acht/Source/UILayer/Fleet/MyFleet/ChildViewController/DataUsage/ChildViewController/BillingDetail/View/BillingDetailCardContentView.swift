...
private extension BillingDetailCardContentView {
    ...
    func updateUI() {
        ...
        items.forEach { (item) in
            ...
            cell.textLabel?.font = UIFont.systemFont(ofSize: 14.0, weight: UIFont.Weight.medium)
            cell.detailTextLabel?.font = UIFont.systemFont(ofSize: 14.0, weight: UIFont.Weight.regular)
