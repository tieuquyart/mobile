...
//            if code == responseError.rawValue {
//                let alert = UIAlertController(title: ConstantMK.language(str: "Alert".localizeMk()) , message: responseError.title(), preferredStyle: UIAlertController.Style.alert)
//                let ok = UIAlertAction(title: ConstantMK.language(str: "confirm"), style: .default, handler: { _ in
//                    self.navigationController?.popViewController(animated: true)
//                })
//                alert.addAction(ok)
//                self.present(alert, animated: true, completion: nil)
//            self.showToast(message: ConstantMK.language(str: self.responseError.title()), seconds: 2.0)
//            self.showToast(viewController: self, message: ConstantMK.language(str: self.responseError.title()))
//            self.popUp(context: self, msg: ConstantMK.language(str: self.responseError.title()))
