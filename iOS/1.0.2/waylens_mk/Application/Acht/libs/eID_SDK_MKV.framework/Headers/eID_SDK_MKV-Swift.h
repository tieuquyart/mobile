...
SWIFT_CLASS("_TtC11eID_SDK_MKV26GuidelineNFCViewController")
@interface GuidelineNFCViewController : UIViewController
@property (nonatomic, copy) void (^ _Nullable backHandler)(void);
- (void)viewDidLoad;
- (void)setLanguageWithIsEnglish:(BOOL)isEnglish;
...
SWIFT_CLASS("_TtC11eID_SDK_MKV13MKIDNFCHelper") SWIFT_AVAILABILITY(ios,introduced=13)
@interface MKIDNFCHelper : NSObject
- (nonnull instancetype)initWithAppId:(int32_t)appId providerSecret:(NSString * _Nonnull)providerSecret OBJC_DESIGNATED_INITIALIZER;
- (void)setUrlWithValue:(NSString * _Nonnull)value;
- (NSString * _Nonnull)getUrl SWIFT_WARN_UNUSED_RESULT;
- (void)getDeviceInfoForRegisterDeviceWithSuccessHandler:(void (^ _Nonnull)(NSString * _Nonnull))successHandler errorHandlerSDK:(void (^ _Nonnull)(NSError * _Nonnull))errorHandlerSDK errorHandler:(void (^ _Nonnull)(enum NFCViewDisplayMessage))errorHandler;
- (void)checkAppActivatedWithSuccessHandler:(void (^ _Nonnull)(BOOL))successHandler errorHandler:(void (^ _Nonnull)(enum NFCViewDisplayMessage))errorHandler;
- (void)doActivateWithAndCustomerId:(NSString * _Nonnull)andCustomerId andBranchId:(NSString * _Nonnull)andBranchId successHandler:(void (^ _Nonnull)(void))successHandler andFailureHandler:(void (^ _Nonnull)(NSError * _Nonnull))andFailureHandler errorHandler:(void (^ _Nonnull)(enum NFCViewDisplayMessage))errorHandler;
- (BOOL)isNFCAvailable SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, NFCPassportReaderError, open) {
  ...
  NFCPassportReaderErrorWrong_key_card = 25,
  NFCPassportReaderErrorNo_face_data = 26,
  NFCPassportReaderErrorRequestdoMoC_NFC = 27,
};
...
typedef SWIFT_ENUM(NSInteger, NFCViewDisplayMessage, open) {
  ...
  NFCViewDisplayMessageTemplateNull = 2,
  NFCViewDisplayMessageINVALID_SDK = 004,
  NFCViewDisplayMessageError_connect_server = 7,
  NFCViewDisplayMessageDevice_not_supported = 9,
  NFCViewDisplayMessageIosVerisionERROR = 11,
  NFCViewDisplayMessageReading = 12,
  NFCViewDisplayMessageNot_success = 93,
  NFCViewDisplayMessageCARD_TIMEOUT = 203,
  NFCViewDisplayMessageNOT_ACTIVATED = 600,
  NFCViewDisplayMessageVERIFY_MOC_SERVER_ERROR = 4301,
  NFCViewDisplayMessageICAO_ERROR = 4302,
  NFCViewDisplayMessageVERIFY_SOD_SERVER_ERROR = 4303,
  NFCViewDisplayMessageFAILED_TO_VERIFY_SOD = 4601,
  NFCViewDisplayMessageVERIFY_MOC_FAILED_WRONG_FACE = 4403,
};
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)readIdInfoWithNfcPopupTitle:(NSString * _Nonnull)nfcPopupTitle bankTransactionId:(NSString * _Nonnull)bankTransactionId andBankTransInfo:(NSString * _Nonnull)andBankTransInfo andBankTransType:(int32_t)andBankTransType delegate:(id <UpdateReaderSessionMessageDelegate> _Nonnull)delegate;
@end
