...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WaylensAPNGKit/WaylensAPNGKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WaylensCameraSDK/WaylensCameraSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WaylensCarlos/WaylensCarlos.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WaylensFoundation/WaylensFoundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WaylensPiedPiper/WaylensPiedPiper.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WaylensUIKit/WaylensUIKit.framework"
  install_framework "${PODS_ROOT}/WaylensVideoSDK/Frameworks/GPUImage.framework"
  install_framework "${PODS_ROOT}/WaylensVideoSDK/Frameworks/IJKMediaFrameworkWithSSL.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WaylensVideoSDK/WaylensVideoSDK.framework"
...
if [[ "$CONFIGURATION" == "Release_adhoc" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireImage/AlamofireImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AloeStackView/AloeStackView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BMPlayer/BMPlayer.framework"
