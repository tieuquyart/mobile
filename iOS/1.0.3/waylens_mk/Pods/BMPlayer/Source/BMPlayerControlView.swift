...
open class BMPlayerControlView: UIView {
    ...
    func setupUIComponents() {
        ...
        subtitleLabel.font = UIFont(name: "BeVietnamPro-Regular", size: 13)!
        ...
        titleLabel.text      = ""
        titleLabel.font      = UIFont(name: "BeVietnamPro-Regular", size: 16)!
        ...
        currentTimeLabel.font       = UIFont(name: "BeVietnamPro-Regular", size: 12)!
        currentTimeLabel.text       = "00:00"
        currentTimeLabel.textAlignment = NSTextAlignment.center
        
        totalTimeLabel.textColor    = UIColor.white
        totalTimeLabel.font         = UIFont(name: "BeVietnamPro-Regular", size: 12)!
        ...
        seekToLabel.font                = UIFont(name: "BeVietnamPro-Regular", size: 13)!
