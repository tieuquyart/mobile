...
@implementation WLDmsDataMapperV6
...
+ (WLDmsData *)mapWithHeader:(eyesight_dms_data_header_t *)header output:(L1OutputV6 *)output personInfo:(nullable eyesight_person_info_t *)personInfo {
    ...
    switch (output->hasGlasses) {
        case ds_v6::TriState::YES_STATE:
            [dmsDict setObject:@(YES) forKey:@(WLDmsDataKeysHasGlasses)];
            break;
        case ds_v6::TriState::NO_STATE:
    ...
    struct ds_v6::Gaze gaze = output->faceCameraCoordinatesSystem.unifiedGaze;
    ...
    struct ds_v6::Rect headRect = output->headRect;
