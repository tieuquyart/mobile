...
protocol SectionIndexViewDelegate: AnyObject {
...
class SectionIndexView: UIView {
    ...
    private(set) var width: CGFloat = 36.0
...
private class SectionIndexViewItem: UIView {
    ...
    var isSelected: Bool = false {
        didSet {
            if isSelected {
                titleLabel.font = UIFont(name: "BeVietnamPro-Semibold", size: 11)!
                titleLabel.textColor = UIColor.semanticColor(.tint(.primary))
            } else {
                titleLabel.font = UIFont(name: "BeVietnamPro-Regular", size: 10)!
