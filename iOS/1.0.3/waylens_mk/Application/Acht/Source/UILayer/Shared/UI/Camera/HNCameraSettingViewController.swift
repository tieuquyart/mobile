...
class HNCameraSettingViewController: BaseTableViewController, CameraRelated {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        initHeader(text: NSLocalizedString("Cấu hình", comment: "Cấu hình"), leftButton: false)
...
//        }
    ...
    override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        if section == 0 {
            ...
            switch row {
               case 0, 1, 2 , 3 , 4 , 5 , 8 , 9 ,10 , 11 , 12 , 15 , 16 , 17 , 18 , 19 : return 0
            default:
                break
            }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case (4, 0):
            ...
            present(alert, animated: true, completion: nil)        case (4, 2):
            let alert = UIAlertController.init(
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        if let settingCell = sender as? CameraSettingCell {
            ...
            if iccid.isEmpty {
                alert(title: WLCopy.simCardNotReported, message: "")
                return false
            }
