...
class CameraTimeLineHorizontalView: UIView, CameraTimeline {
    ...
    func setLiveButtonStyle(ratio: CGFloat) {
        ...
        liveButton.layer.borderColor = UIColor.black.cgColor
        ...
        liveButton.titleLabel?.font = UIFont(name: "BeVietnamPro-Regular", size: 14)
    }
