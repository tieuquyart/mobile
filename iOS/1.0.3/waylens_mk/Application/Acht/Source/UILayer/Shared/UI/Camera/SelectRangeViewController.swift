    ...
    var overlayHeight: CGFloat {
        ...
        set {
            ...
            if newValue > overlayMargin {
                durationLabel.font = UIFont(name: "BeVietnamPro-Medium", size: 30)
            } else {
                durationLabel.font = UIFont(name: "BeVietnamPro-Medium", size: 25)
            }
...
//        handleTrailingSpace.constant = layout.thumbnailRightSpace - 1
        ...
        timeScaleBoard.font = UIFont(name: "BeVietnamPro-Regular", size: 45)!
