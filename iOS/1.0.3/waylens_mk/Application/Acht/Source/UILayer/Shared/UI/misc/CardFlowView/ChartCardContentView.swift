...
class ChartCardContentView: UIView {
    ...
    private var dateLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont(name: "BeVietnamPro-Regular", size: 10)!
    ...
    enum ChartConfig {
        static let labelFont = UIFont(name: "BeVietnamPro-Regular", size: 10)!
...
private extension ChartCardContentView {
    ...
    func setupBarChartView() {
        ...
        xAxis.labelFont = UIFont(name: "BeVietnamPro-Regular", size: 10)!
        xAxis.granularity = 1
        ...
        leftAxis.labelFont = UIFont(name: "BeVietnamPro-Regular", size: 10)!
        ...
        l.form = .none
        l.formSize = 9
        l.font = UIFont(name: "BeVietnamPro-Regular", size: 11)!
        l.xEntrySpace = 4

        let marker = XYMarkerView(color: UIColor.color(fromHex: "#36A410"),
        ...
        marker.chartView?.layer.cornerRadius = 5
        ...
        case .bar:
            ...
            if let newEntries = chartData?.barChartDataSetEntries {
                ...
                if let set = barChartView.data?.dataSets.first as? BarChartDataSet {
                    ...
                    dataSet.setColor(UIColor.color(fromHex: "#6BC1FF"))
                    dataSet.highlightColor = UIColor.color(fromHex: "#0B4296")
                    dataSet.highlightAlpha = 1.0
                    dataSet.drawValuesEnabled = false
                    let data = BarChartData(dataSet: dataSet)
                    data.setValueFont(UIFont(name: "BeVietnamPro-Regular", size: 10)!)
                    data.barWidth = 0.8
        ...
        case .line:
            ...
            if let newEntries = chartData?.lineChartDataSetEntries {
                ...
                if let set = lineChartView.data?.dataSets.first as? LineChartDataSet {
                    ...
                    set1 = LineChartDataSet(entries: newEntries, label: "")
                    set1.drawValuesEnabled = false
                    set1.drawIconsEnabled = false

                    set1.fillAlpha = 1
//                    set1.fill = Fill(color: UIColor.black.withAlphaComponent(0.5))
                    ...
                    set1.valueFont = UIFont(name: "BeVietnamPro-Regular", size: 9)!
                    set1.form = .none
...
extension ChartCardContentView {
