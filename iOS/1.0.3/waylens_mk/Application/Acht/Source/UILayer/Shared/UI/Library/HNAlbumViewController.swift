...
class HNAlbumViewController: BaseTableViewController {
    ...
    private lazy var batchDeleteButton: UIButton = { [weak self] in
        ...
        batchDeleteButton.titleLabel?.font = UIFont(name: "BeVietnamPro-Regular", size: 10.0)
    ...
    override func viewWillLayoutSubviews() {
        ...
        batchDeleteButton.frame.size.width = view.frame.width - 32
    }
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        if isEditing != editing {
            ...
            if editing {
                ...
                batchDeleteButton.frame = CGRect(x: 16.0, y: 0.0, width: batchDeleteButtonSize.width - 32, height: batchDeleteButtonSize.height)
                batchDeleteButton.isEnabled = false
                batchDeleteButton.layer.cornerRadius = 10
