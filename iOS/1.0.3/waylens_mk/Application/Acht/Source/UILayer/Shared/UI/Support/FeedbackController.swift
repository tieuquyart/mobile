...
class FeedbackController: BaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setBorderView(view: backgroundView)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.initHeader(text: NSLocalizedString("Report an Issue", comment: "Report an Issue"), leftButton: false)
    ...
    func createButton(title: String?) -> UIButton {
        ...
        btn.titleLabel?.font = UIFont(name: "BeVietnamPro-Regular", size: 14)
            ...
            case .success(let value):
                ...
                ConstantMK.parseJson(dict: value, handler: {success, msg, code in
                    if success{
                        ...
                        HNMessage.dismiss(withDelay: 2.0)
