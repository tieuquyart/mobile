...
class ActionSheetController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if title?.isEmpty == false {
            ...
            headerLabel.font = UIFont(name: "BeVietnamPro-Regular", size: 12)!
        ...
        destructiveActions.forEach { (action) in
            ...
            destructiveButton.titleLabel?.font = UIFont(name: "BeVietnamPro-Regular", size: 14)
        ...
        for (i, action) in cancelActions.enumerated() {
            ...
            cancelButton.titleLabel?.font = UIFont(name: "BeVietnamPro-Light", size: 14) ?? UIFont(name: "BeVietnamPro-Regular", size: 14)
