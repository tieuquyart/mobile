...
class CableCell: UITableViewCell, Themed {
    ...
    private func setup() {
        ...
        wrapperView.addShadow(offset: CGSize(width: 3, height: 4))
...
//        wrapperView.layer.shadowOpacity = 1.0
    ...
    func applyTheme() {
        ...
        if isSelected {
            nameLabel.font = UIFont(name: "BeVietnamPro-Semibold", size: 14)!
            ...
            nameLabel.font = UIFont(name: "BeVietnamPro-Regular", size: 14)!
