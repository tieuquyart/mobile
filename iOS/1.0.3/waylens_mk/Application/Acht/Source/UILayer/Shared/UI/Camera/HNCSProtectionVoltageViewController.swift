...
class HNCSProtectionVoltageViewController: HNCSRadioChoiceBaseViewController<BatteryProtectionChoice> {
    ...
    private lazy var showAdditionalChoiceButton: UIButton = { [weak self] in
        ...
        showAdditionalChoiceButton.titleLabel?.font = UIFont(name: "BeVietnamPro-Regular", size: 12)
    ...
    override func applyTheme() {
        ...
        showAdditionalChoiceButton.setTitleColor(UIColor.black, for: .normal)
        showAdditionalChoiceButton.addUnderline(with: UIColor.black)
    }
