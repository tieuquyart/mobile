...
//        durationLabel.isHidden = true
        ...
        if let thumbnailUrl = URL(string: alert.thumbnailUrl) {
            ...
            uploadingStatusView.backgroundColor = UIColor.black.withAlphaComponent(0.6)
            contentView.alpha = 1.0
            isUserInteractionEnabled = true
        } else {
            thumbnail.image = nil
            uploadingStatusView.backgroundColor = UIColor.black
...
//        uploadingIcon.isHidden = !(alert.hasVideo && (alert.uploadStatus?.isUploading ?? false))
        ...
        if alert.isRead {
            senderLabel.font = UIFont(name: "BeVietnamPro-Regular", size: 14)
            dateLabel.font = UIFont(name: "BeVietnamPro-Regular", size: 20)
            subInfo.font = UIFont(name: "BeVietnamPro-Regular", size: 14)
        } else {
            senderLabel.font = UIFont(name: "BeVietnamPro-Bold", size: 14)
            dateLabel.font = UIFont(name: "BeVietnamPro-Regular", size: 20)
            subInfo.font = UIFont(name: "BeVietnamPro-Bold", size: 14)
        }
    }
