...
fileprivate class ConnectionStatusView: UIButton {
    ...
    private func update() {
        ...
        titleLabel?.font = UIFont(name: "BeVietnamPro-Regular", size: fontSize)
        ...
        case .viaWiFi:
            ...
            imageTitleSpace = 0.0
        case .via4G:
            titleLabel?.font = UIFont(name: "BeVietnamPro-Bold", size: fontSize)
    ...
    var numberOfEvents: Int = 0 {
        didSet {
            ...
            attributedString.addAttributes( // style number string
                [
                    NSAttributedString.Key.font : UIFont(name: "BeVietnamPro-Medium", size: 20)!,
