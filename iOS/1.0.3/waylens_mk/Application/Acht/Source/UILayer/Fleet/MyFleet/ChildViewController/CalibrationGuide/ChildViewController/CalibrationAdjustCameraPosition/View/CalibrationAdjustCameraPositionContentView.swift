...
class CalibrationAdjustCameraPositionContentView: CalibrationPlayerContentView {
    private var warningLabel: UILabel = {
        ...
        label.font = UIFont(name: "BeVietnamPro-Regular", size: 16)!
        label.text = NSLocalizedString("Let the driver look forward with an ordinary driving posture. Adjust the camera to make the driver image fit in the mask. Keep adjusting till the mask turn into green.", comment: "Let the driver look forward with an ordinary driving posture. Adjust the camera to make the driver image fit in the mask. Keep adjusting till the mask turn into green.")
