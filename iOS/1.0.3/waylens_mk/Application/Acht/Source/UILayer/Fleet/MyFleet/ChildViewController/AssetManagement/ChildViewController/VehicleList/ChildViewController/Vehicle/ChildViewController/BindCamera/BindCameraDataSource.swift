...
public class BindCameraDataSource: TableArrayDataSource<CameraProfile> {

    public var selectedIndexPath: IndexPath? = nil
    public var selectedItem: CameraProfile? {
    ...
    public convenience init(items: [CameraProfile], selectedIndexPath: IndexPath? = nil) {
        self.init(
            array: items,
            tableSettings: [
