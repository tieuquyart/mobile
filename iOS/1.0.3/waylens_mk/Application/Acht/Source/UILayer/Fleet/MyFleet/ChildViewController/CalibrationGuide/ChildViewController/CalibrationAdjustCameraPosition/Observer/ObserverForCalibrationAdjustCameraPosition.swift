//
//  ObserverForCalibrationAdjustCameraPosition.swift
//  Fleet
//
...
class ObserverForCalibrationAdjustCameraPosition: Observer {

    weak var eventResponder: ObserverForCalibrationAdjustCameraPositionEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<CalibrationAdjustCameraPositionViewControllerState>
    ...
    init(state: Observable<CalibrationAdjustCameraPositionViewControllerState>) {
        self.state = state
    }
