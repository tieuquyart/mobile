...
class AddNewGeoFenceRootView: ViewContainTableViewAndBottomButton {
    ...
    private lazy var nextButton: UIButton = { [weak self] in
        let nextButton = ButtonFactory.makeBigBottomButton(NSLocalizedString("Next", comment: "Next"), color: UIColor.black)
    ...
    private var textView: UITextView = {
        ...
        textView.font = UIFont(name: "BeVietnamPro-Regular", size: 14)!
