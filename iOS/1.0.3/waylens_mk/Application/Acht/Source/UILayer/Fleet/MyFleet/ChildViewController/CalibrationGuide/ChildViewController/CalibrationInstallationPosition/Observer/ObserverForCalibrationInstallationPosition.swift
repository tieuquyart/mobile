//
//  ObserverForCalibrationInstallationPosition.swift
//  Fleet
//
...
class ObserverForCalibrationInstallationPosition: Observer {

    weak var eventResponder: ObserverForCalibrationInstallationPositionEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<CalibrationInstallationPositionViewControllerState>
    ...
    init(state: Observable<CalibrationInstallationPositionViewControllerState>) {
        self.state = state
    }
