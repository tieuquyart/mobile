...
//    @IBOutlet private weak var callButton: UIButton!
    ...
    func setFontLabel(label : UILabel) {
        label.font = UIFont(name: "BeVietnamPro-Bold", size: 14)!
...
//        setBorderView(view: self.viewTopStack)
         self.viewTopStack.addShadow(offset: CGSize(width: 3, height: 4))
...
//        }
    ...
    func update(with driver: Driver) {
        ...
        eventLabel.text = "\(driver.statistics.mileage.localeStringValue) km"
        ...
        if !driver.statistics.timeGPS.isEmpty {
            timeLabel.text = "\(driver.statistics.duration.localeStringValue) h"/*driver.statistics.timeGPS.fixTimeLabel()*/
            timeLabel.isHidden = false
        } else {
            timeLabel.isHidden = true
        }
