...
//        invertButton.titleLabel?.font = UIFont(name: "BeVietnamPro-Medium", size: 16)
//        invertButton.setTitle("  " + NSLocalizedString("Invert", comment: "Invert"), for: .normal)
        invertButton.setTitleColor(UIColor.color(fromHex: ConstantMK.blueButton), for: .normal)
        invertButton.isEnabled = false
//        invertButton.layer.cornerRadius = 8
//        invertButton.layer.borderWidth = 1
//        invertButton.layer.borderColor = UIColor.color(fromHex: ConstantMK.blueButton).cgColor
        return invertButton
    }()
