...
class TriggeringVehicleSelectorScopeSpecificStateView: UIView {
    ...
    func applyTheme() {
        ...
        selectAllView.textLabel?.textColor = UIColor.black
...
private class TriggeringVehicleSelectorHeaderView: UIView {
...
private class SelectAllView: UITableViewCell {
