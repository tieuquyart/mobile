...
class TripDetailTimelineViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        initHeader(text: "Go Detail".localizeMk(), leftButton: true)
    ...
    func setFontButton(button : UIButton) {
        button.titleLabel?.font = UIFont(name: "BeVietnamPro-Bold", size: 8)!
    ...
    func setFontLabel(label : UILabel) {
        label.font = UIFont(name: "BeVietnamPro-Bold", size: 13)
    ...
    override func applyTheme() {
        super.applyTheme()
        self.view.backgroundColor = UIColor.color(fromHex: "#EDEEF4")
        setBorderView(view: self.viewGoDetail)
        setBorderView(view: self.viewLiveStream)
//        setBorderView(view: self.calendarViewContainer)
//        setBorderView(view: self.viewTopHeader)
        
        self.calendarViewContainer.addShadow(offset: CGSize(width: 3, height: 4))
        self.viewTopHeader.addShadow(offset: CGSize(width: 3, height: 4))
        
        plateLabel.text = driver.vehicle.plateNumber
        labelName.text = self.name
        self.viewContent.backgroundColor = UIColor.color(fromHex: "#EDEEF4")
...
extension TripDetailTimelineViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cellTrip.setBorderWithExpanded(isExpanded: self.allItems[indexPath.section].isExpanded )
            return cellTrip
        } else {
