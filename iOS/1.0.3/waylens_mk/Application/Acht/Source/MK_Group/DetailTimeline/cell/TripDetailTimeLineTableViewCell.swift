...
//        self.viewBrand.dashedBorder()
        setBorder(self.viewBrand)
    ...
    func setBorder(_ v: UIView){
        v.backgroundColor = UIColor.color(fromHex: "#F3F6F8")
        v.layer.cornerRadius = 8
        v.layer.borderWidth = 1
        v.layer.borderColor = UIColor.color(fromHex: ConstantMK.borderGrayColor).cgColor
...
extension UIView {
    ...
    func dashedBorder(){
        ...
        yourViewBorder.path = UIBezierPath(roundedRect: self.bounds, cornerRadius: 8).cgPath
