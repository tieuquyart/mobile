...
class CameraService : CameraAPI  {
    ...
    func updateFaceIdToServer(cameraSn: String, numberId: String, faceId: String, completion: completionBlock?) {
        statusReportProvider.request(.updateFaceIdToServer(cameraSn: cameraSn, numberId: numberId, faceId: faceId), completionHandler: completion)
    }
    func deleteFaceIdToServer(cameraSn: String, completion: completionBlock?) {
        statusReportProvider.request(.deleteFaceIdToServer(cameraSn: cameraSn), completionHandler: completion)
    }
