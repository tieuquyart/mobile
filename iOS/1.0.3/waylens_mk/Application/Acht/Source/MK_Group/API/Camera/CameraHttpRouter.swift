...
enum CameraHttpRouter {
    ...
    case updateFaceIdToServer(cameraSn: String, numberId: String, faceId: String)
    case deleteFaceIdToServer(cameraSn: String)
}
...
extension CameraHttpRouter : TargetType {
    ...
    var path: String {
        ...
        case .deleteFaceIdToServer(cameraSn: _):
            return "api/admin/camera/delete/faceId"
        case .updateFaceIdToServer(cameraSn: _ , numberId: _, faceId: _):
            return "api/admin/camera/update/faceId"
        }
    }
    
    var method: Moya.Method {
        switch self {
        case .add, .register , .checkSerial, .updateFaceIdToServer, .deleteFaceIdToServer:
            return .post
    ...
    var task: Moya.Task {
        ...
        case .delete , .register :
            return .requestPlain
        case .updateFaceIdToServer(cameraSn: let cameraSn, numberId: let numberId, faceId: let faceId):
            let parameters: [String : Any] = [
                "cameraSn" : cameraSn,
                "numberId" : numberId,
                "faceId" : faceId
        ...
        case .deleteFaceIdToServer(cameraSn: let cameraSn):
            let parameters: [String : Any] = [
                "cameraSn" : cameraSn,
            ]
            return .requestCompositeParameters(
