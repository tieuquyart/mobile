...
class NotiListViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        btnShowListNoti.layer.cornerRadius = 8
        btnShowListNoti.layer.masksToBounds = true
        getListNotifi()
        unread_total()
...
//                          getStringFromCategory("SYSTEM"),
        ...
        self.btnShowListNoti.addShadow(offset: CGSize(width: 3, height: 4))
    }
...
//            return "FORWARD_COLLISION"
    ...
    func setupChooseDropDown() {
        ...
        chooseDropDown.textFont = UIFont(name: "BeVietnamPro-Regular", size: 14.0)!
