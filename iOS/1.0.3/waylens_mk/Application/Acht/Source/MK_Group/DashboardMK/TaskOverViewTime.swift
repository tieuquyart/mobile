...
//            view.layer.borderColor = UIColor.color(fromHex: ConstantMK.borderGrayColor).cgColor
   ...
   // let chooseLabelTime = DropDown()
    ...
    func setupchooseShowDate() {
        ...
        chooseShowDate.layer.cornerRadius = 8
        chooseShowDate.addShadow(offset: CGSize(width: 3, height: 4))
        ...
        chooseShowDate.textFont = UIFont(name: "BeVietnamPro-Regular", size: 14.0)!
        chooseShowDate.textColor = UIColor.black
        chooseShowDate.show()
