...
class DashboardMKViewcontroller: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        pagingViewController.menuItemSize = .fixed(width: 240 , height: 45)
        pagingViewController.menuBackgroundColor = UIColor.color(fromHex: "#EDEEF4")
        pagingViewController.selectedTextColor = UIColor.color(fromHex: ConstantMK.blueButton)
        pagingViewController.textColor = UIColor.color(fromHex: "#9AA7B6")
        pagingViewController.indicatorColor = UIColor.color(fromHex: ConstantMK.blueButton)
        
        pagingViewController.font = UIFont(name: "BeVietnamPro-Medium", size: 14)!
        pagingViewController.selectedFont = UIFont(name: "BeVietnamPro-Medium", size: 14)!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.initHeader(text: NSLocalizedString("Dashboard", comment: "Dashboard"), leftButton: false)
