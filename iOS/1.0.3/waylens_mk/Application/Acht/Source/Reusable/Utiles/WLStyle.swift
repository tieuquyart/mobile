...
extension UIButton {
    ...
    func applyMainStyle() {
        self.titleLabel?.font = UIFont(name: "BeVietnamPro-Medium", size: 16)
        self.layer.cornerRadius = 8
        self.clipsToBounds = true
        self.setBackgroundImageColor(UIColor.color(fromHex: ConstantMK.blueButton), disabledColor: UIColor.semanticColor(.background(.quaternary)))
    }
