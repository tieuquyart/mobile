...
class InfoBasicCameraViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib(nibName: "InfoBasicCameraHeaderViewCV", bundle: nil), forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "InfoBasicCameraHeaderViewCV") //elementKindSectionFooter for footerview
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        title = NSLocalizedString("Thông tin cơ bản", comment: "Thông tin cơ bản")
...
//        let signalStatusMobile = InfoCameraMKModel(key: "Signal status mobile".localizeMk(), value: model.sigStt)
        let typeCMRGSHT  = InfoCameraMKModel(key: "Type CMRGSHT".localizeMk(), value: model.type)
        //let seriNumberCMRGSHT = InfoCameraMKModel(key: "Seri Number CMRGSHT".localizeMk(), value: model.sn)
...
//        let UpdateSoftwareNearest = InfoCameraMKModel(key: "Update Software Nearest".localizeMk(), value: model.lastUpdated)
//        let statusGPS  = InfoCameraMKModel(key: "Status GPS".localizeMk(), value:"\(model.GPSStt)")
...
//        let drivingTimeContinuity = InfoCameraMKModel(key: "Driving Time Continuity".localizeMk(), value: "\(model.contDrvTime)")
//        let infomationGPS = InfoCameraMKModel(key: "Infomation GPS/GNSS".localizeMk(), value: model.GPSInfo)
//        let speed = InfoCameraMKModel(key: "Speed".localizeMk(), value: "\(model.speed)")
