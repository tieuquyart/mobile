...
class LoginFaceRootView: FlowStepRootView<LoginFaceContentView> {
    weak var ixResponder: LoginFaceIxResponder?
    ...
    override func setup() {
     ...
     //   progressLabel.text = "4 / 5"
      //  actionButton.setTitle(NSLocalizedString("Ready to Calib", comment: "Ready to Calib"), for: .normal)
        actionButton.setTitle(NSLocalizedString("Login_face" , comment:  "Login_face"), for: .normal)
...
private extension LoginFaceRootView {
...
extension LoginFaceRootView: LoginFaceUserInterface {
    func screenShort() {
