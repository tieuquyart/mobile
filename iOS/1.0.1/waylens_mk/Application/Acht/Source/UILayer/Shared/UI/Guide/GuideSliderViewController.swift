...
class GuideSliderViewController: UIViewController, GuideController {
    ...
    override func viewDidLoad() {
        ...
        icon.bounds = CGRect(x: 0, y: UIFont.systemFont(ofSize: 14).descender, width: 19, height: 19)
        ...
        attributed.append(NSAttributedString(string: NSLocalizedString("Motion  ", comment: "Motion  "), attributes: [.foregroundColor : UIColor.semanticColor(.activity(.motion))]))
        attributed.append(NSAttributedString(string: NSLocalizedString("people_approaching_car_keying", comment: "people approaching, car keying\n"), attributes: [.foregroundColor : UIColor.semanticColor(.label(.secondary))]))
        attributed.append(NSAttributedString(string: NSLocalizedString("Bump  ", comment: "Bump  "), attributes: [.foregroundColor : UIColor.semanticColor(.activity(.hit))]))
        attributed.append(NSAttributedString(string: NSLocalizedString("knocking_bumps", comment: "knocking, bumps\n"), attributes: [.foregroundColor : UIColor.semanticColor(.label(.secondary))]))
        attributed.append(NSAttributedString(string: NSLocalizedString("Impact  ", comment: "Impact  "), attributes: [.foregroundColor : UIColor.semanticColor(.activity(.heavy))]))
