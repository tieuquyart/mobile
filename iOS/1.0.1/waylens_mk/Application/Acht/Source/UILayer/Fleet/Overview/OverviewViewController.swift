...
class OverviewViewController: BaseViewController {
    ...
    private lazy var goBackButton: UIBarButtonItem = { [weak self] in
        let goBackButton = UIBarButtonItem(image: UIImage(named: "navbar_back_n"), style: UIBarButtonItem.Style.plain, target: self, action: #selector(goBackButtonTapped(_:)))
        goBackButton.imageInsets = UIEdgeInsets(top: 0, left: -15, bottom: 0, right: 0)
        return goBackButton
    }()
    ...
    func configRightBarButton() {
        ...
        self.navigationItem.setRightBarButtonItems([item1 , smsBarButton], animated: true)
    }
...
//        title = NSLocalizedString("Overview" , comment: "Overview")
        ...
        profileImageView.addTapGesture {
        ...
        titleLabel.text = NSLocalizedString("Overview" , comment: "Overview")
        
//        NotificationCenter.default.addObserver(self, selector: #selector(numberDidChange), name: Notification.Name.AppIconBadge.numberDidChange, object: nil)
...
extension UIViewController {
    ...
    func showActivityIndicator() {
        ...
        activityIndicatorView.frame = CGRect(x: 0.0, y: 0.0, width: 14.0, height: 14.0)
        activityIndicatorView.color = UIColor.black
        activityIndicatorView.startAnimating()
        
        let titleLabel = UILabel()
        titleLabel.attributedText = NSAttributedString(string: NSLocalizedString("Loading...", comment: "Loading..."), attributes: UINavigationBar.appearance().titleTextAttributes)
