//
//  ObserverForSecureEsNetworkMobilePhoneStepOne.swift
//  Fleet
//
...
class ObserverForSecureEsNetworkMobilePhoneStepOne: Observer {

    weak var eventResponder: ObserverForSecureEsNetworkMobilePhoneStepOneEventResponder? {
        willSet {
            if newValue == nil {
                stopObserving()
            }
    ...
    let state: Observable<SecureEsNetworkMobilePhoneStepOneViewControllerState>
    ...
    init(state: Observable<SecureEsNetworkMobilePhoneStepOneViewControllerState>) {
        self.state = state
    }
