...
class DIYCalendarCell: FSCalendarCell {
    ...
    override init(frame: CGRect) {
        ...
        todayLayer.fillColor = UIColor.semanticColor(.fill(.tertiary)).cgColor
        ...
        selectionLayer.fillColor = UIColor.semanticColor(.tint(.primary)).cgColor
    ...
    override func configureAppearance() {
        ...
        if self.isPlaceholder {
            ...
            if isInContinuousSelectionRange {
                titleLabel.font = UIFont.systemFont(ofSize: appearance.titleFont.pointSize, weight: UIFont.Weight.black)
            } else {
