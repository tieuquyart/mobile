...
public enum HNVideoType: Int {
    ...
    var description: String {
        ...
        case .upload_faile:
            return NSLocalizedString("Upload_fail", comment: "Upload_fail")
        case .smoking:
        ...
        case .noSeatBelt:
            return NSLocalizedString("No_Seatbelt", comment: "No_Seatbelt")
        case .distracted:
    ...
    var color: UIColor {
        ...
        case .noDriver, .drowsiness, .drinking, .smoking, .phoneCalling, .upload_faile,
             .asleep, .daydreaming, .yawn, .distracted, .attentive, .noSeatBelt:
...
class HNClip: BasicClip {
    ...
    init(dict: [String: Any]) {
        ...
        startDate = Date(timeIntervalSince1970: (dict["startTime"] as? TimeInterval ?? 0)/1000)
